...
public class MultiConcept1 {
	public static void main(String[] args) {
		 ...
		 * 
		 * Cost of communication between the process is high. Switching from one process
		 * to another requires some time for saving and loading registers, memory maps,
		 * updating lists, etc.
		 * 
		 * 
